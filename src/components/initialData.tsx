...
export const initialBoard: (ChessPiece|null)[][] = [
    ...
    [new Pawn(PieceColor.Black, [1, 0]),new Pawn(PieceColor.Black, [1, 1]),new Pawn(PieceColor.Black, [1, 2]),new Pawn(PieceColor.Black, [1, 3]),new Pawn(PieceColor.Black, [1, 4]),new Pawn(PieceColor.Black, [1, 5]),new Pawn(PieceColor.White, [1, 6]),new Pawn(PieceColor.Black, [1, 7])],
    ...
    [new Pawn(PieceColor.White, [6, 0]),new Pawn(PieceColor.White, [6, 1]),new Pawn(PieceColor.White, [6, 2]),new Pawn(PieceColor.White, [6, 3]),new Pawn(PieceColor.White, [6, 4]),new Pawn(PieceColor.White, [6, 5]),new Pawn(PieceColor.Black, [6, 6]),new Pawn(PieceColor.White, [6, 7])],
